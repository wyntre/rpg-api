...
// TileType is used by pop to map your .model.Name.Proper.Pluralize.Underscore database table to your go code.
type TileType struct {
	ID             uuid.UUID     `json:"id" db:"id"`
	Name           string        `json:"name" db:"name"`
	TileCategoryID uuid.UUID     `json:"tile_category_id" db:"tile_category_id"`
	TileCategory   *TileCategory `json:"tile_category,omitempty" belongs_to:"tile_category"`
...
// TileTypes is not required by pop and may be deleted
